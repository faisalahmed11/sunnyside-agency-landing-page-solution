...
return(
  ...
  <h1 onClick={()=>setActive(!active)}>{title}</h1>
<div>
<p>{body}</p>
</div>
</div>
...
<Accordion title={"ipsam reiciendis beatae dignissimos sunt"}
body={"quis illum, voluptatem quas! Culpa repellendus tempore vitae tempora consequatur minima debitis ea dolorem ipsam reiciendis beatae dignissimos sunt itaque quasi maiores, quod eum repellat iusto ex vel, eius doloremque. Est cumque voluptates numquam eligendi quae vero perferendis at reprehenderit nulla necessitatibus? Eum reprehenderit beatae odio et rerum exercitationem asperiores culpa quasi dolorum"}
/>

<Accordion title={"ipsam reiciendis beatae dignissimos"}
